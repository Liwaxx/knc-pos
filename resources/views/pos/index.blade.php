...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @if (session()->has('failed'))
                <div class="alert text-white bg-danger" role="alert">
                    <div class="iq-alert-text">{{ session('failed') }}</div>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <i class="ri-close-line"></i>
                    </button>
                </div>
        ...
        <div class="card card-block card-stretch card-height col-lg-6 col-md-12 mb-3">
            <div class="card-body">
            <table class="table">
                <thead>
                    <tr class="ligth">
                ...
                <div class="d-flex">
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="d-flex flex-wrap align-items-center justify-content-center">
                                <button type="submit" class="btn btn-success add-list mx-1 w-100">Create Invoice</button>
                            </div>
                        </div>
                </div>
            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pos.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                            ...
                                            <button type="submit" class="btn btn-primary border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add"><i class="fa-solid fa-plus mr-0"></i></button>
                                        </form>
                                    </td>
                                </tr>
